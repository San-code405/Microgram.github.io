...
var commenta = yeah + "if(commar == '' || commar == ' ' || commar == '  ' || commar == '   ' || commar == '    ' || commar == '     ' || commar == '      ' || commar == '       ' || commar == '        ' || commar == '         ' || commar == '          '){}else{document.getElementById('gitClone_y_" + identities2 + "commentBox_A').innerHTML+= '<div><span></span><p>' + donut + '</p></div>'; " + _1556 + "}";
...
var vice = main + _9 + 'Your name' + _10 + _7 + _23 + _21 + _19 + _8 + _11 + document.getElementById('resultant').innerHTML + "<i class='time'>" + date + " " + month + " " + year + " " + hour + ":" + minute + " " + amPm + "</i>";
